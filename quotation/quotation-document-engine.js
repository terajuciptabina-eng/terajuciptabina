...
const CONTACT_FOOTER_RESERVE_PX=Math.ceil(20*PX_PER_MM);
...
function appendContactFooter(page,contactFooter){
 ...
 clone.style.left='0';
 clone.style.right='0';
 clone.style.bottom=Math.ceil(2*PX_PER_MM)+'px';
 clone.style.width='100%';
 clone.style.height='16mm';
 clone.style.boxSizing='border-box';
 clone.style.margin='0';
 clone.style.padding='2mm 4mm 1mm';
