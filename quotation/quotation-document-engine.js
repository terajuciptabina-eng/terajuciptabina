...
const CONTACT_FOOTER_RESERVE_PX=Math.ceil(26*PX_PER_MM);
const PAGE_BOTTOM_SAFETY_PX=Math.ceil(6*PX_PER_MM);
...
/* QUOTATION LAYOUT CONTRACT
   The quotation document follows the actual quotation table structures generated by
   renovationplanner.html.
   Simple: Description / Unit / Quantity / Rate / Amount.
...
body.renovation-planner-page .simple-quotation-table td:nth-child(1){text-align:left!important}
body.renovation-planner-page .simple-quotation-table th:nth-child(2),
body.renovation-planner-page .simple-quotation-table td:nth-child(2){text-align:left!important}
...
body.renovation-planner-page .simple-quotation-table td:nth-child(5){text-align:right!important}
body.renovation-planner-page .simple-quotation-table th:last-child,
body.renovation-planner-page .simple-quotation-table td:last-child{padding-right:0!important}
body.renovation-planner-page .simple-quotation-table td:nth-child(1){overflow-wrap:break-word!important;word-break:normal!important;white-space:normal!important}
body.renovation-planner-page .simple-quotation-table td:nth-child(2),
body.renovation-planner-page .simple-quotation-table td:nth-child(3),
body.renovation-planner-page .simple-quotation-table td:nth-child(4),
body.renovation-planner-page .simple-quotation-table td:nth-child(5){white-space:nowrap!important}
body.renovation-planner-page .simple-quotation-table col:nth-child(1),
body.renovation-planner-page .simple-quotation-table th:nth-child(1),
body.renovation-planner-page .simple-quotation-table td:nth-child(1){width:50%!important}
body.renovation-planner-page .simple-quotation-table col:nth-child(2),
body.renovation-planner-page .simple-quotation-table th:nth-child(2),
body.renovation-planner-page .simple-quotation-table td:nth-child(2){width:10%!important}
body.renovation-planner-page .simple-quotation-table col:nth-child(3),
body.renovation-planner-page .simple-quotation-table th:nth-child(3),
body.renovation-planner-page .simple-quotation-table td:nth-child(3){width:10%!important}
body.renovation-planner-page .simple-quotation-table col:nth-child(4),
body.renovation-planner-page .simple-quotation-table th:nth-child(4),
body.renovation-planner-page .simple-quotation-table td:nth-child(4){width:15%!important}
body.renovation-planner-page .simple-quotation-table col:nth-child(5),
body.renovation-planner-page .simple-quotation-table th:nth-child(5),
body.renovation-planner-page .simple-quotation-table td:nth-child(5){width:15%!important}
...
function appendContactFooter(page,contactFooter,options={}){
 ...
 clone.style.left='0';
 clone.style.right='0';
 clone.style.bottom=Math.ceil(3*PX_PER_MM)+'px';
 clone.style.width='100%';
 clone.style.height='20mm';
 clone.style.boxSizing='border-box';
 clone.style.margin='0';
 clone.style.padding='1.5mm 4mm 1mm';
 clone.style.borderTop='1px solid #d1d5db';
 clone.style.fontFamily='Arial,Helvetica,sans-serif';
 clone.style.fontSize=(options.mobilePreview?'12px':'9px');
...
async function buildPaginatedPages(source,options={}){
 const mobilePreview=options.mobilePreview===true;
 const working=source.cloneNode(true);
 working.classList.remove('quotation-render-source','quotation-locked');
 const contactFooter=working.querySelector('.quotation-contact-footer');
 if(contactFooter)contactFooter.remove();
 ...
 const pushBodyPage=()=>{if(page.tbody.children.length){appendContactFooter(page,contactFooter,{mobilePreview});pages.push(page.root)}};
 ...
 if(tfoot){
  ...
  if(pageHeight(page)>USABLE_HEIGHT_PX){
   ...
   appendContactFooter(page,contactFooter,{mobilePreview});
...
function appendRenderedPageNumber(page,index,total){
 const el=document.createElement('div');
 el.className='quotation-render-page-number';
 el.textContent=`Page ${index+1} of ${total}`;
...
async function renderQuotationPreview(options={}){const forPdf=options.forPdf===true;const mobilePreview=!forPdf&&window.matchMedia?.('(max-width: 767px)').matches;injectStyles();const source=document.getElementById('quotationContent'),stage=document.getElementById('quotationPreview');if(!source||!stage)return;stage.innerHTML='<div class="quotation-preview-loading">Preparing visual quotation preview…</div>';try{await loadQuotationCanvas();const pageRoots=await buildPaginatedPages(source,{mobilePreview});pageRoots.forEach((root,index)=>appendRenderedPageNumber(root,index,pageRoots.length));const pages=await rasterizePages(pageRoots);window.__quotationPreviewPages=pages.map(p=>p.src);window.__quotationPreviewPageMeta=pages;stage.innerHTML=pages.map((p,i)=>`<div class="quotation-preview-page"><img src="${p.src}" alt="Quotation page ${i+1}"></div>`).join('')}catch(error){console.error(error);stage.innerHTML='<div class="quotation-preview-loading">Unable to prepare the visual quotation preview. You can still try Download PDF.</div>'}}
...
function install(){injectStyles();bindQuotationTypeCards();window.renderQuotationPreview=renderQuotationPreview;window.printQuotation=printQuotation;window.TERAJU_QUOTATION_DOCUMENT_ENGINE_VERSION='2026-09-22-footer-v4'}
