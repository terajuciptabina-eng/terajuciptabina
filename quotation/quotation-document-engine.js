...
#quotationPreview .quotation-preview-loading{width:100%;padding:32px 20px;text-align:center;border:1px dashed #d1d5db;border-radius:16px;background:#fafafa;color:#6b7280}#quotationPreview .quotation-preview-page{position:relative!important}#quotationPreview .tc-column-resize-layer{position:absolute!important;pointer-events:none!important;z-index:20!important;box-sizing:border-box!important}#quotationPreview .tc-column-resizer{position:absolute;display:block;width:14px;cursor:col-resize;pointer-events:auto;touch-action:none;box-sizing:border-box;transform:translateX(-50%)}#quotationPreview .tc-column-resizer::after{content:"";position:absolute;top:0;bottom:0;left:6px;width:2px;background:rgba(17,24,39,.22);border-radius:2px}#quotationPreview .tc-column-resizer:hover::after,#quotationPreview .tc-column-resizer.is-dragging::after{background:rgba(17,24,39,.7);width:3px}body.tc-quotation-column-dragging{cursor:col-resize!important;user-select:none!important}body.tc-quotation-column-dragging *{user-select:none!important}
...
function install(){injectStyles();bindQuotationTypeCards();window.renderQuotationPreview=renderQuotationPreview;window.printQuotation=printQuotation;window.TERAJU_QUOTATION_DOCUMENT_ENGINE_VERSION='2026-09-19-excel-column-resize-v8'}
